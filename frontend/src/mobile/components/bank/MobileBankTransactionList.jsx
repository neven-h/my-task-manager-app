        ...
        <div style={{ position: 'relative', overflow: 'hidden' }}>
            ...
            >
                ...
                <div style={{
                    ...
                    background: isTransferIn ? 'rgba(52,199,89,0.15)' : isCash ? 'rgba(255,215,0,0.15)' : isTransferOut ? 'rgba(255,59,48,0.1)' : 'rgba(0,0,255,0.08)',
                    display: 'flex', alignItems: 'center', justifyContent: 'center'
                }}>
                    {isTransferIn ? <ArrowDownLeft size={17} color="#34C759" />
                     : isTransferOut ? <ArrowUpRight size={17} color="#FF3B30" />
                     : isCash ? <DollarSign size={17} color="#B8860B" />
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    <div style={{ fontSize: '0.74rem', color: '#888', marginTop: 2, display: 'flex', alignItems: 'center', gap: 6 }}>
                        ...
                        <span style={{
                            ...
                            background: isTransferIn ? 'rgba(52,199,89,0.15)' : isCash ? 'rgba(255,215,0,0.2)' : isTransferOut ? 'rgba(255,59,48,0.1)' : 'rgba(0,0,255,0.08)',
                            color: isTransferIn ? '#16a34a' : isCash ? '#8B6914' : isTransferOut ? '#FF3B30' : '#0000CC',
                            fontSize: '0.68rem', fontWeight: 500
                        }}>{isTransferIn ? 'Transfer In' : isTransferOut ? 'Transfer Out' : isCash ? 'Cash' : 'Credit'}</span>
                    </div>
                </div>
