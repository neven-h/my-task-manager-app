    ...
    <div style={{ minHeight: '100vh', background: '#fff', fontFamily: 'Inter, system-ui, sans-serif' }}>
      ...
      <div style={{ padding: '16px' }}>
        {loading ? (
          ...
          <>
            {/* Completion Rate */}
            <div style={{ background: '#f8f8f8', border: '3px solid #000', padding: '20px', marginBottom: '16px' }}>
              <h3 style={{ fontSize: '0.85rem', fontWeight: 700, textTransform: 'uppercase', marginBottom: '12px' }}>
                Completion Rate
              </h3>
            ...
            {/* Total Hours */}
            <div style={{ background: '#FFD500', border: '3px solid #000', padding: '20px', marginBottom: '16px' }}>
              <h3 style={{ fontSize: '0.85rem', fontWeight: 700, textTransform: 'uppercase', marginBottom: '12px' }}>
                Total Hours
              </h3>
              <div style={{ fontSize: '2rem', fontWeight: 900 }}>
            ...
            {stats.total_revenue !== undefined && (
              <div style={{ background: '#0000FF', color: '#fff', border: '3px solid #000', padding: '20px', marginBottom: '16px' }}>
                <h3 style={{ fontSize: '0.85rem', fontWeight: 700, textTransform: 'uppercase', marginBottom: '12px' }}>
                  Total Revenue
                </h3>
                <div style={{ fontSize: '2rem', fontWeight: 900 }}>
            ...
            <div style={{ background: '#fff', border: '3px solid #000', padding: '20px' }}>
              <h3 style={{ fontSize: '0.85rem', fontWeight: 700, textTransform: 'uppercase', marginBottom: '16px' }}>
                Task Breakdown
              </h3>
...
const MobileBankTransactionsView = ({ authUser, authRole, onBack }) => {
  return (
    <div style={{ minHeight: '100vh', background: '#fff' }}>
      {/* Header */}
      <div style={{ background: '#fff', borderBottom: '3px solid #000', padding: '16px', position: 'sticky', top: 0, zIndex: 100 }}>
