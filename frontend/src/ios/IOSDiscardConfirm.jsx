...
const IOSDiscardConfirm = ({ isOpen, isEditing, onKeepEditing, onDiscard }) => {
    ...
    return (
        ...
        >
            ...
            >
                <h3 style={{
                    fontSize: '1.2rem', fontWeight: 900, margin: '0 0 12px 0',
                    textTransform: 'uppercase', fontFamily: FONT_STACK, color: THEME.text
                }}>
                    Unsaved changes
                </h3>
                <p style={{ margin: '0 0 24px 0', fontSize: '1rem', color: THEME.muted, lineHeight: 1.5 }}>
                    {isEditing
...
export default React.memo(IOSDiscardConfirm);
