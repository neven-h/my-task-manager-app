...
from routes.tasks_drafts import tasks_drafts_bp
...
from routes.attachments_serve import attachments_serve_bp
...
from routes.portfolio_watchlist_prices import portfolio_watchlist_prices_bp
...
from routes.transaction_tabs_ops import transaction_tabs_ops_bp
...
from routes.budget_tabs_delete import budget_tabs_delete_bp
...
from routes.budget_upload import budget_upload_bp
from routes.budget_balance import budget_balance_bp
from routes.fixed_flag import fixed_flag_bp
...
from routes.transaction_batch_rename import transaction_batch_rename_bp
...
app.register_blueprint(tasks_drafts_bp)
...
app.register_blueprint(attachments_serve_bp)
...
app.register_blueprint(portfolio_watchlist_prices_bp)
...
app.register_blueprint(transaction_tabs_ops_bp)
...
app.register_blueprint(budget_tabs_delete_bp)
app.register_blueprint(budget_export_bp)
app.register_blueprint(budget_predict_bp)
app.register_blueprint(budget_links_bp)
app.register_blueprint(budget_upload_bp)
app.register_blueprint(budget_balance_bp)
app.register_blueprint(fixed_flag_bp)
...
app.register_blueprint(transaction_batch_rename_bp)
